...
// TODO KIP-547 REMOVE — Temporary IES endpoint for ArcGIS feature service verification
@Slf4j
@RestController
@RequiredArgsConstructor
@RequestMapping("/api/execution/arcgis/verification")
@PreAuthorize("hasRole('tenant_admin') and hasRole('feature_arcgis_integration')")
public class ArcGISVerificationController {

    private final ArcGISVerificationService arcGISVerificationService;
    ...
    public ResponseEntity<ArcGISVerificationPageResponse> getFeatures(
        ...
        ArcGISVerificationPageResponse response =
                arcGISVerificationService.queryFeatures(offset, objectId, locationId);
